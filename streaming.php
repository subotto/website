...
<video id="my_video_1" class="video-js vjs-default-skin" width="800" height="450" controls
  ...
  data-setup="{}">
  <?php
  echo '<source src="http://soyuz.sns.it:8000/low.ts" type="video/MP2T">';
  ?>
</video>
</center>
...
echo '<p>Link diretto allo streaming (<a href="http://soyuz.uz.sns.it:8000/low.ts">bassa qualit&agrave;</a>, <a href="http://soyuz.uz.sns.it:8000/hi.ts">alta qualit&agrave;</a>).</p>';
